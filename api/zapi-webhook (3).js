    ...
    if (body.fromMe === false && body.text && body.text.message) {
      ...
      const claudeRes = await fetch('https://api.anthropic.com/v1/messages', {
        ...
        body: JSON.stringify({
          ...
          messages: [{
            role: 'user',
            content: `Você é um SDR especialista em planos de saúde empresariais. Enviou mensagem de prospecção para a empresa "${contato.nome || nomeEmpresa}" e recebeu a seguinte resposta:
...
Retorne APENAS um JSON válido sem markdown:
{
  ...
  "resposta": "sua resposta em até 3 linhas, tom amigável e profissional. Se nao_quer, deixe vazio."
}
